...
public class RenderAcid extends Render{
	...
	public static final ResourceLocation AcidTexture = new ResourceLocation("biomod:textures/entity/throwable/AcidG.png");
	@Override
    public void doRender(Entity entity, double x, double y, double z, float f, float f1) {
        ...
        renderEngine.bindTexture(AcidTexture); //绑定贴图
