package cn.BiochemistryCraft.Entity.EntityAI;
...
public class LavaZombieBeNLazyAI extends EntityAITarget
{
    ...
    private final LavaZombieBeNLazyAI.Sorter theNearestAttackableTargetSorter;
    /**
    ...
    public LavaZombieBeNLazyAI(EntityLavaZombie p_i1665_1_, Class<? extends EntityLivingBase> p_i1665_2_, int p_i1665_3_, boolean p_i1665_4_, boolean p_i1665_5_, final IEntitySelector p_i1665_6_)
    {
        ...
        this.theNearestAttackableTargetSorter = new LavaZombieBeNLazyAI.Sorter(p_i1665_1_);
        this.setMutexBits(1);
        this.targetEntitySelector = new IEntitySelector()
        {
            ...
            {
                return !(p_82704_1_ instanceof EntityLivingBase) ? false : (p_i1665_6_ != null && !p_i1665_6_.isEntityApplicable(p_82704_1_) ? false : LavaZombieBeNLazyAI.this.isSuitableTarget((EntityLivingBase)p_82704_1_, false));
            }
        };
    }
