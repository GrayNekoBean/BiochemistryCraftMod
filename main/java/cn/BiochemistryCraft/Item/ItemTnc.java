...
public class ItemTnc extends Item{
	...
	public ItemTnc(){
		super();
		this.setTextureName("Theneedlecylinder");
		this.setCreativeTab(CreativeTabs.tabTools);
		this.setUnlocalizedName("Theneedlecylinder");
...
if(!el.worldObj.isRemote){
    	if(el instanceof EntityCow){		
    		this.getBloob(e, BCCRegisterItem.cowblood);
    		return true;
    		...
    		el.entityDropItem( new ItemStack(BCCRegisterItem.mooshroomblood, 1, 0), 1.0F);
    		...
    		el.entityDropItem( new ItemStack(BCCRegisterItem.ghastblood, 1, 0), 1.0F);
    ...
    public boolean getBloob(EntityPlayer player,Item item){
    	  ItemStack itemstack = player.inventory.getCurrentItem();

          if (itemstack != null && itemstack.getItem() == BCCRegisterItem.Theneedlecylinder )
          {
